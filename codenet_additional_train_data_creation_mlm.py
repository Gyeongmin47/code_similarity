...
pair_data.to_csv('data/new_dataset_0607/mlm_codenet_train_bm25L.csv', index=False)
...
pair_data.to_csv('data/new_dataset_0607/mlm_codenet_valid_bm25L.csv', index=False)